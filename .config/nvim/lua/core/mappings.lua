...
M.refactoring = {
  n = {
    ["<leader>rI"] = { ":Refactor inline_func<CR>", "Inline function" },
    ["<leader>rb"] = { ":Refactor extract_block<CR>", "Extract block" },
    ["<leader>rbf"] = { ":Refactor extract_block_to_file<CR>", "Extract block to file" },
  },
  x = {
    ["<leader>re"] = { ":Refactor extract<CR>", "Extract" },
    ["<leader>rf"] = { ":Refactor extract_to_file<CR>", "Extract to file" },
    ["<leader>rv"] = { ":Refactor extract_var<CR>", "Extract variable" },
    ["<leader>ri"] = { ":Refactor inline_var<CR>", "Inline variable" },
  },
}
